...
export default async function ShelfQueuePage() {
  ...
  return <div className="admin-content">
    <header className="admin-page-heading"><div><h2>Shelf photo review</h2><p>New photos are analyzed automatically. Resolve unclear labels or failed analysis and prepare proposals for their owners to publish. Oldest 50 pending photos appear first.</p></div></header>
