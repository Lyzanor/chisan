...
export default async function ShelfQueuePage() {
  ...
  return <div className="admin-content">
    <header className="admin-page-heading"><div><h2>Shelf photo review</h2><p>Admit suitable photos before any AI analysis. Then check label evidence, producer matches and point positions before publication. Oldest 50 pending photos appear first.</p></div></header>
