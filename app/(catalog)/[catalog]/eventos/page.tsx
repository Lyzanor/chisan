...
export default function EventsPage() {
  ...
  return <main className={styles.page}>
    ...
    <header className={styles.header}>
      <p className="chisan-eyebrow">Agenda editorial · España</p>
      <h1 className="chisan-enter">Ferias para conocer a quienes producen.</h1>
      <p>Encuentros de alimentos y bebidas con fecha, lugar y productores contrastados en el catálogo de Chisan.</p>
    </header>
    <section className={styles.eventGrid} data-reveal-stagger aria-label="Eventos publicados">
