# Chisan image direction

Approved on 2026-09-14: **Product in the light**. The
[selected reference](references/product-in-the-light.png) sets the decorative
image language, not new catalog fields, product claims or map coordinates.

## Photography

Producer photos show the actual people, product and place in natural light.
Keep their useful detail, colour and texture. No generated scene or generic
category photo is evidence of a real producer's work.

Category decoration uses a separate high-key still life on pure white: one
recognizable food subject, few supporting elements, soft shadows, generous
white margins and natural ivory, green, gold or fruit colour. In the page, make
it small, diffuse and low-opacity, located in the outer body margins below the
header. Keep foreground photos sharp, text readable and map geography clear.

The first assets are cheese and wine. Other categories keep the white base
until a matching asset is reviewed. New categories use this same visual language,
without reusing a photograph that depicts the wrong product.
...
is not generated or redrawn as part of this image system.
