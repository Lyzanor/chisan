...
supplies no separate icon, so the app icon reverses that same C on a forest
square. The same initial C appears in producer and selection QR centres.
...
| `assets/chisan-icon-light.png` | App icon, 512 px, reversed C on forest |
