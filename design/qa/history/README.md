> Historical verification record. For the current visual system use [design/README.md](../../README.md); for the latest check use [design-qa.md](../design-qa.md). Earlier logo decisions and rejected treatments below are historical, not active instructions.
