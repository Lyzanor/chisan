...
de grafías y dedup). Detalle por lote en `git log --follow -p -- docs/verificacion/es/barcelona.md`.
La verdad es el CSV; tras el cierre, la pasada de ampliación «flujo 2026» (julio, ledger en
`docs/candidates/es/barcelona.md`) subió el catálogo a ~2.545 filas. Recuentos vivos:
...
- Candidatos DAR no integrados: movidos a `docs/candidates/es/barcelona.md` § «Herencia del ledger
