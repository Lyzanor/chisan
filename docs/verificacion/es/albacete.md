...
- Tras AB-04 (2026-07-21): **114 filas**; **84 `pendiente`, 3 `parcial`, 27
  ...
  la evidencia a `docs/candidates/es/cuenca.md`. Dos `sí` heredados bajaron a
...
- `purge:other-province`: Pago de La Jaraba → `docs/candidates/es/cuenca.md`.
...
- `purge:other-province`: Embutidos Carrizal → `docs/candidates/es/ciudad-real.md`.
