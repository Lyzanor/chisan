...
`git log --follow -p -- docs/verificacion/es/girona.md`; procedencia por fila en
...
- La nota de candidatos de Girona quedó cerrada; pistas nuevas → `docs/candidates/es/girona.md`.
