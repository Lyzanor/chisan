...
- No existe `docs/candidates/es/baleares.md`. No se añaden candidatos salvo petición
...
- **La primera fila inventada de la provincia.** `oli-de-sant-joan-sant-joan` se
  ...
  `docs/candidates/es/baleares.md`: **no se reaprovecha la fila cambiándole la
...
- **Tres filas que no son productores.** «Sobrasada de Mallorca Ferrer» (Algaida)
  ...
  en `docs/candidates/es/baleares.md`.
...
7. `docs/candidates/es/baleares.md` guarda **Gossalba, Procam, Bon Gust** y los
