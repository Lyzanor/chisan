...
- Candidatos: `docs/candidates/es/teruel.md` conserva lotes DO y de jamón todavía
...
- La nota `docs/candidates/es/teruel.md` no conserva candidatos abiertos de esta
