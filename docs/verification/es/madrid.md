...
`git log --follow -p -- docs/verificacion/es/madrid.md`; la verdad es el CSV.
...
- Pistas no integradas: `docs/candidates/es/madrid.md` (heladerías pendientes de filtro de obrador propio).
