...
- Candidatos: `docs/candidates/es/zaragoza.md` contiene dos lotes DO ya resueltos y
...
- `docs/candidates/es/zaragoza.md` queda sin diferidos: las cooperativas de grupo
