...
- Filas: **2.876** · `verificado` **529** · `parcial` **231** · `pendiente` **2.116**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 97 filas** y verificado/parcial el resto).
- Modo: **verificación profunda**, **lote a lote bajo demanda** (~25 filas/lote). ~90 lotes estimados.
- **Cerrados:** Lotes 1-19.
  **Lote 19 = Moià** COMPLETO (38 pend en una pasada: 9 verif + 24 parcial + 5 purgas).
  **Capital del Moianès**, comerç de poble. Fuente clave: **DAR Moianès** (12 filas confirmades: embotits,
  formatges de cabra, mel, ous). **Recats per web/DAR:** Biobastona era "Pan y pastelería" → **vedella eco +
  cereals** (recat **Productos ecológicos**); Nadolç era "Despensa/mel" → **lactis eco** iogurt/kèfir (recat
  **Lácteos y quesos**); La Moianesa era "Charcutería" → **fàbrica de pasta** 1880 (recat **Pasta artesana**,
  +web); Agrícola Bach Oller era "Huevos" → **NOUS** (recat **Frutos secos**, marca Nous El Soler, +web,
  ecommerce); Delícia de Mel i Garriga Molviedro → **Miel**. **VO sí/ecommerce:** Formatges Montbrú, Nous El
  Soler. **Verif sense shop:** Cal Vives (1901), Cal Noc (1917, millor botifarra d'ou de Cat.), Pastisseria
  Àger ("ni enviem ni distribuïm"), Alpines Les Feixes. **Cross-links blanquejats:** Forn de Dalt i Cal Tià
  (web `calbou1885.com`=Forn Cal Bou, altra adreça), La Granoia (`moia.cat`). **5 purgues:** Cuesta
  Terricabras (bodega fantasma: junk moia.cat + tel ajuntament, sense celler real), Roca Iglesias (email/tel
  del ajuntament), Illa Alibés (agronet.org), Molins Paronella = **dup d'Alpines Les Feixes** (Francesc, Les
  5 Feixes, mateix tel), SAT Granja La Gonima (sense dades). Sense imatges òrfenes.
- **Siguiente:** Lote 20 = **Caldes de Montbui** (31 pendientes → ~2 sub-lotes).
- Último push: **lotes 1-18 en `main`**. **Pendiente de push: lote 19** (este commit).
