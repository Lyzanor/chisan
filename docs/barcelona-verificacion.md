...
- Filas: **2.871** · `verificado` **539** · `parcial` **247** · `pendiente` **2.085**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 102 filas** y verificado/parcial el resto).
- Modo: **verificación profunda**, **lote a lote bajo demanda** (~25 filas/lote). ~90 lotes estimados.
- **Cerrados:** Lotes 1-20.
  **Lote 20 = Caldes de Montbui** COMPLETO (31 pend en una pasada: 10 verif + 16 parcial + 5 purgas; +1 parcial previa).
  Comerç de poble (Vallès Oriental). Fuentes: **DAR Caldes** (10 filas) + **guia agrària de l'Ajuntament**
  (caldesdemontbui.cat). **VO sí/ecommerce:** Unika Beer, Abel Artesans Xarcuters (des de 1890), Embotits
  Pedragosa, Agrícola Mas Curró (EVOO, **recat Despensa→Aceite**), Umai. **VO no/no comprobado:** Olis La
  Xerona (EVOO, **recat Aceite**), Pastes Sanmartí (**fàbrica de pasta des de 1700** amb aigua termal, recat
  **Pasta artesana**), Espiga Blanca, Fleca Turón (cert TLS), Can Orjusa (formatgeria 1987, mató; ACREFA +
  Patrimoni). **2 dups registre↔marca (DAR):** Ayguasanosa Grauges=**XERONA** (=Olis La Xerona) i Picanyol
  Traveria=**PICANYOL** (=Agro-Picanyol) → purgats. **Cross-links blanquejats:** Casino Bueno (`casinodecaldes.cat`
  =casino social; DAR confirma carn→parcial, +tel/correu DAR), Agro-Picanyol (`agricaldes.com`=botiga/garden
  center; VO sí era erroni→no comprobado). **5 purgues:** 2 dups + Manubens Ramoneda (web bisbat/parròquia +
  coords +30km), Martínez Sànchez (IG perruqueria + email de Can Orjusa), Soler Panadés (web=majorista HVAC
  Soler Teselen) — cap als 3 al DAR ni a la guia municipal. +1 imatge òrfena esborrada (Soler Panadés).
- **Siguiente:** Lote 21 = **Piera** (28 pendientes → ~2 sub-lotes).
- Último push: **lotes 1-18 en `main`**. **Pendiente de push: lotes 19 y 20** (commits locales).
