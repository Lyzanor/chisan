...
- Filas: **2.705** · verificado **1.053** · parcial **502** · pendiente **1.150**
  (snapshot inicial 2.973 · 35 · 16 · 2.922; **268 purgadas**).
- Modo: lote a lote bajo demanda, ~25 filas/lote, ~90 lotes estimados. **Cerrados: lotes 1-78** (worklist).
- **Siguiente: Lote 79** — Papiol (11).
