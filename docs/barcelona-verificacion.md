...
- Filas: **2.652** · verificado **1.191** · parcial **556** · pendiente **905**
...
- Modo: lote a lote bajo demanda, ~25 filas/lote, ~90 lotes estimados. **Cerrados: lotes 1-103** (worklist).
- **Siguiente: Lote 104** — empatados a 9 pendientes: Sant Just Desvern /
...
| — | _resto (309 municipios)_ | 1.311 | ⬜ | | recomputar al llegar |
