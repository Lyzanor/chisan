...
- Filas: **2.815** · verificado **701** · parcial **370** · pendiente **1.744**
  (snapshot inicial 2.973 · 35 · 16 · 2.922; **158 purgadas**).
- Modo: lote a lote bajo demanda, ~25 filas/lote, ~90 lotes estimados. **Cerrados: lotes 1-35** (worklist).
- **Siguiente: Lote 36 = Sant Celoni** (19 pendientes).
