...
- Filas: **2.864** · `verificado` **562** · `parcial` **273** · `pendiente` **2.029**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 109 filas** y verificado/parcial el resto).
- Modo: **verificación profunda**, **lote a lote bajo demanda** (~25 filas/lote). ~90 lotes estimados.
- **Herramienta nueva (lote 22):** `node scripts/match-dar.mjs "<municipio>"` cruza las filas `pendiente`
...
- **Cerrados:** Lotes 1-22.
  **Lote 22 = Subirats** COMPLETO (28 pend en una pasada: 11 verif + 14 parcial + 3 purgas).
  Alt Penedès, **zona vinícola** (gairebé tot cellers/cava). Triaje amb `match-dar.mjs` (13/28 al DAR).
  **Cellers verif VO sí/ecommerce:** Can Bas, Eudald Massana Noya, Sabaté i Coca/Castellroig (1885, Corpinnat),
  Cava Bertha, Sumarroca (+web sumarroca.es), El Tros d'Ordal (eco, →verdures.cat), Les Filós (melmelades
  artesanes, Lavern). **Verif VO no:** Júlia Bernet, Oliver Viticultors, Esteve i Gibert (Cal Panxa, 8a gen),
  Carles de Lavern (cert TLS). **Parcial DAR:** Massana Ràfols (Felix Massana), Ozcariz Raventós, Saumell
  Vallès, Familia Esteve Ràfols (**recat Despensa→Fruta**), Mallofré (MEL CAN MALLOFRÉ→**Miel**), Manel
  Massana, Ràfols Raventós (CAL JAN→**Fruta**, coords BCN→Subirats), Cerclemon, Olivella Font Clara (+contacte
  DAR). **Parcial local:** Olivariana (**Aceite**), Maset del Lleó, Mas Pujadó (web suspesa), Finca Ca la Font
  de Jui, Josep Guilera. **3 purgues:** Amell Bertran (web `anaamell.com`=**psicoterapeuta BCN**; ferreamell=
  celler Baix Penedès/Tarragona, coords costa), Raventós Vendrell (web `raventos.com`=**Raventós i Blanc**, ja
  al lote 14), Josep Olivella Rossell (**dup d'Olivella Font Clara**, DAR). +1 imatge esborrada.
- **Siguiente:** Lote 23 = **Tordera** (28 pendientes → ~2 sub-lotes).
- Último push: **lotes 1-20 en `main`**. **Pendiente de push: lotes 21 y 22** (commits locales).
