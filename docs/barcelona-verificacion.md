...
- Filas: **2.867** · `verificado` **551** · `parcial` **259** · `pendiente` **2.057**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 106 filas** y verificado/parcial el resto).
- Modo: **verificación profunda**, **lote a lote bajo demanda** (~25 filas/lote). ~90 lotes estimados.
- **Cerrados:** Lotes 1-21.
  **Lote 21 = Piera** COMPLETO (28 pend en una pasada: 12 verif + 12 parcial + 4 purgas).
  Anoia (frontera Alt Penedès) → molta "Bodega"/cava. Fuente clave: **DAR Piera** (8 filas). **Cavas/cellers
  verif amb VO sí:** Cava Gabarró, Cava Pagès Entrena (1950), Celler Mas del Vidre, Torrens Moliner (ecommerce);
  Clot de les Soleres + Turrai (comandes **whatsapp**). **VO no:** Cava Maria Casanovas (1984), Cal Sadurní
  (molí d'oli, **recat Aceite**), Torrents Viñas (préssecs, DAR). **Altres verif:** Cafès Mama Same (torrador,
  shop), Fruits Secs Termens=Aperitius Catalans (**recat Despensa→Frutos secos**, botiga). **Recats per DAR:**
  Bedous era "Pan y pastelería" → **granja d'ous CCPAE** (recat **Huevos**); Poch Samsó era "Bodega" → **POCH
  fruita/préssecs/olives** (recat Fruta y verdura; web samsoembotits.com=embotits BCN **blanquejat**, coords
  BCN→Piera, +img esborrada); Torrens Martí "Otros"→**Fruta** (FORDAL). **Parcial DAR:** Torres Álvarez (Torres
  de la Serra, vins+oli), Duran Duran (Masia de Santa Creu, conserves; coords BCN→Piera), De la Maria Eco.
  **4 purgues (mis-fichades BCN + cross-links):** Canti Marrugat (web `vpiera.com`=material de belles arts BCN),
  Josep Llop Vallverdú (web `casapiera.com`=Casa Piera Belles Arts BCN), Rovira Duran Maria (**dup de De la
  Maria Eco**, DAR), Centro AMMA (centre espiritual Amritanandamayi, no productor). +2 imatges esborrades.
- **Siguiente:** Lote 22 = **Subirats** (28 pendientes → ~2 sub-lotes).
- Último push: **lotes 1-20 en `main`**. **Pendiente de push: lote 21** (este commit).
