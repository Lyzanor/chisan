...
- Filas: **2.858** · `verificado` **568** · `parcial` **289** · `pendiente` **2.001**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 115 filas** y verificado/parcial el resto).
...
- **Cerrados:** Lotes 1-23.
  **Lote 23 = Tordera** COMPLETO (28 pend en una pasada: 6 verif + 16 parcial + 6 purgas).
  Maresme hortícola (mongeta, horta). Triaje `match-dar.mjs`: **16/28 al DAR**. **Verif:** CUICK (sofritos/
  picadas, ecommerce), Can Ricastell (=Eduardo Sánchez, agro), Agrària Baixa Tordera (coop, DAR), Can Freixas
  (xarcuteria), Ecotràmec (verdura eco, DAR), Ramaderia Jordi Torres (carn boví, DAR). **Parcial DAR:** Galli
  (SALACE vins), Masó Martínez (HORTA MASÓ, **recat Bodega→Fruta y verdura**), Monfulleda (Can Bibot), Goula
  (mel→**Miel**), Joan Manresa (mongeta→**Legumbres**), Juli Centellas, Mateu Méndez, Santi Manresa, Unió Puig,
  Cal Mexica (ous), Mas Muñoz (Hortalisses Mas→**Fruta y verdura**). **Cross-links blanquejats:** Joan Manresa
  (`elrusc.cat`=**Fundació El Rusc**, L'Arche; +tel DAR), Santi Manresa + Vicenç Bigas CB (`cftordera.cat`=
  **C.F. Tordera futbol**), Vicenç Bigas SCP (`elcamitordera.cat`=**centre de psicologia**). **6 purgues:**
  3 dups (Rosell Vergés=Ecotràmec, Eduardo Sánchez=Can Ricastell, Jose Jofre Masagur=Jofre Bellido) + Vicenç
  Bigas CB (dup d'SCP, web futbol) + 2 sense dades (Serra Vila, Vilajeliu Serra). Sense imatges òrfenes.
- **Siguiente:** Lote 24 = **Berga** (25 pendientes → 1 sub-lote).
- Último push: **lotes 1-22 en `main`**. **Pendiente de push: lote 23** (este commit).
