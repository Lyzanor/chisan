...
- Filas: **2.899** · `verificado` **373** · `parcial` **161** · `pendiente` **2.365**
...
- **Cerrados:** Lotes 1-12. Lote 9 Mataró (50), Lote 10 Manresa (45), Lote 11 Vic (46),
  **Lote 12 = Vilanova i la Geltrú** COMPLETO (40 pend en una pasada: 20 verif + 11 parcial + 9 purgas).
  DAR Garraf (12 filas) destapó dups marca↔persona: Sínia Sant Gervasi = Gimeno Mestre Remei **y** Jaume
  (2 hermanos, misma sínia), Sínia Alsina = Alsina Soler Josep. Patrón estrella: **webs cruzadas a empresas
  ajenas** por apellido (Banc Sabadell por "Marce Sabadell", Ametller Origen por "Amatlle", Finques Rius
  por "Rius", Steknos). botigas demo sin checkout (Cornet, Canelons Pubill) corregidas a Venta online=no.
- **Siguiente:** Lote 13 = **Vilafranca del Penedès** (38 pendientes → ~2 sub-lotes).
- Último push: lote 12 en `main`. Pendiente de push: ninguno.
