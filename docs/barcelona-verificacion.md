...
- Filas: **2.896** · `verificado` **444** · `parcial` **175** · `pendiente` **2.277**
- Snapshot inicial era 2.973 · 35 · 16 · 2.922 (se han **purgado 77 filas** y verificado/parcial el resto).
- Modo: **verificación profunda**, **lote a lote bajo demanda** (~25 filas/lote). ~92 lotes estimados.
- **Cerrados:** Lotes 1-14. Lote 12 Vilanova (40), Lote 13 Vilafranca (38),
  **Lote 14 = Sant Sadurní d'Anoia** COMPLETO (50 pend en una pasada: 43 verif + 4 parcial + 3 purgas).
  **Capital del cava:** casi todo real y famoso (Codorníu, Freixenet, Gramona, Juvé&Camps, Recaredo,
  Raventós i Blanc, Mestres, Agustí Torelló, Vilarnau, Pere Ventura, Canals&Munné…); la mayoría con
  `shop.*`/botiga propia → VO=sí. Sub-marcas reales con tel/web compartida del celler madre (Mas Escorpí +
  Vins per Estimar el Vi = Gramona; Finca Espiells = Juvé&Camps; Celler Credo = Recaredo). Cross-link a
  empresa ajena: Cartró Parera→`maquinariamoderna.com` + tel de Parera Assessors (purgado). Nombres de
  registro **rescatados** por su marca real: Francisco Domínguez=**Molí Parellada**, Soler-Jové (1985),
  Masia Ginebreda, Unió Cellers del Noya, Can Quetu (cava des de 1954). DAR Sant Sadurní: Explotacions
  Agrícoles 23 (ceba/calçot)→parcial. Sufijo "(Celler Kripta)" erróneo en Jaume Giró (Kripta es d'Agustí
