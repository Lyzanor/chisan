...
|---|---|---|---|---|
| Cannavacciuolo Aniello | Angri | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-335.html) |
| Aurella | Ascea Marina | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-114.html) |
| Isca delle Donne | Centola | `Aceite` + `Conservas` + `Fruta y verdura` | olivo e olio, conserve e confetture, ortaggi, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-96.html) |
| Corbella | Cicerale | `Aceite` + `Conservas` + `Fruta y verdura` | olivo e olio, conserve e confetture, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-41.html) |
| Azienda Sperimentale Regionale Improsta | Eboli | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-1.html) |
| Pagnotto Giuseppe – Azienda Le Cammarose | Felitto | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-293.html) |
| La Valle del Mulino | Montecorice | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-340.html) |
| Azienda Agricola Carbone Cosimo | Montecorvino Pugliano | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-409.html) |
| Terra di vento | Montecorvino Pugliano | `Aceite` + `Fruta y verdura` + `Condimentos` | olivo e olio, ortaggi, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-266.html) |
| L'Oliveto di Corrado Anna Maria | Montecorvino Rovella | `Aceite` + `Fruta y verdura` | olivo e olio, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-286.html) |
| Azienda Agricola Zootecnica di Insalata Teresa | Oliveto Citra | `Aceite` + `Carne` | olivo e olio, salumi e carni | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-301.html) |
| Solare di Genovese Maria | Perito | `Aceite` + `Conservas` + `Condimentos` | olivo e olio, conserve e confetture, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-270.html) |
| Agriturismo Il Ponte di Annibale | Ricigliano | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-300.html) |
| Azienda Agricola Vespoli Michele - Agriturismo Macchiapiede | Sala Consilina | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-32.html) |
| San Basilio | Salento | `Aceite` + `Carne` + `Fruta y verdura` | olivo e olio, salumi e carni, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-185.html) |
| Carbone Liliana | San Gregorio Magno | `Aceite` + `Fruta y verdura` | olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-183.html) |
...
| Il Poggio di Vallelunga | Montesano sulla Marcellana | `Conservas` + `Fruta y verdura` | conserve e confetture, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-162.html) |
| Dani Coop. Soc. Coop. Agricola | Sarno | `Conservas` + `Fruta y verdura` | conserve e confetture, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-15.html) |
| San Leo | Acerno | `Fruta y verdura` + `Condimentos` | ortaggi, frutta, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-25.html) |
| Coppola Gennaro - Parco Natura San Donato | Eboli | `Fruta y verdura` + `Pescado` | ortaggi, acquacoltura-pesca | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-381.html) |
| Dell'Orto Antonietta | Eboli | `Fruta y verdura` | ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-305.html) |
| Fattoria Alvaneta | Padula | `Fruta y verdura` | ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-269.html) |
| Vi. San. Flor. di Vittorio Sangiorgio | Pagani | `Fruta y verdura` + `Condimentos` | ortaggi, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-345.html) |
| Antica Masseria di Sguazzo Antonio | Pontecagnano Faiano | `Fruta y verdura` | ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-240.html) |
| Paolillo Michele | Pontecagnano Faiano | `Fruta y verdura` | ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-70.html) |
| La Fonte Società Agricola | Sala Consilina | `Fruta y verdura` + `Pescado` | frutta, acquacoltura-pesca | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-425.html) |
| Scuola Secondaria di I grado Giovanni Amendola | Sarno | `Fruta y verdura` | ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-189.html) |
| Azienda Agricola Guariglia di Guariglia Pierpaolo – La Grande Quercia | Serre | `Fruta y verdura` | ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-271.html) |
| Agriturismo Costiera Amalfitana | Tramonti | `Fruta y verdura` | ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-13.html) |
| Azienda agricola Giuliano Erminia di Nicodemo Nicola - Masseria Cugno | Acerno | `Lácteos y quesos` + `Conservas` | latte e formaggi, conserve e confetture | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-382.html) |
| Azienda Agricola Zootecnica Caseificio Chirico Benedetto | Ascea | `Lácteos y quesos` | latte e formaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-370.html) |
| La Fattoria del Cilento | Ascea Marina | `Lácteos y quesos` + `Aceite` + `Fruta y verdura` | latte e formaggi, olivo e olio, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-131.html) |
| Tempa del Niglio di Criscuolo Antonia | Ascea Marina | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-113.html) |
| Antica Masseria La Morella | Battipaglia | `Lácteos y quesos` + `Aceite` + `Miel` | latte e formaggi, olivo e olio, miele e api, ortaggi, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-61.html) |
| Azienda Agricola Tempio di Barlotti Gianluigi | Capaccio | `Lácteos y quesos` | latte e formaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-294.html) |
| Torre Alberto | Capaccio | `Lácteos y quesos` | latte e formaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-358.html) |
| Agriturismo Parmenide | Castelnuovo Cilento | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-234.html) |
| La Selva | Cava de' Tirreni | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-97.html) |
| Agricola Gorrieri - srl semplificata | Centola | `Lácteos y quesos` + `Conservas` + `Miel` | latte e formaggi, conserve e confetture, miele e api | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-339.html) |
| San Felice | Cicerale | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-193.html) |
| Terra Nostra - My land di Salomone Filippo | Corleto Monforte | `Lácteos y quesos` + `Aceite` + `Carne` | latte e formaggi, olivo e olio, salumi e carni | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-338.html) |
| Azienda Agricola DE.NI.GIO. Sas di De Nigris Claudio - Il mondo di Heidi | Eboli | `Lácteos y quesos` + `Aceite` + `Fruta y verdura` | latte e formaggi, olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-186.html) |
| Feudo Ron Alfre' | Eboli | `Lácteos y quesos` + `Fruta y verdura` + `Pescado` | latte e formaggi, ortaggi, acquacoltura-pesca | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-267.html) |
| Tenuta Baroni Galdieri | Fisciano | `Lácteos y quesos` + `Aceite` + `Carne` | latte e formaggi, olivo e olio, salumi e carni, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-212.html) |
| La Vammora di Piserchia Luciano | Laviano | `Lácteos y quesos` + `Aceite` + `Fruta y verdura` | latte e formaggi, olivo e olio, frutta, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-296.html) |
| Le Parisien srl | Montecorvino Pugliano | `Lácteos y quesos` | latte e formaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-368.html) |
| Masseria Sparano | Montecorvino Rovella | `Lácteos y quesos` + `Aceite` + `Fruta y verdura` | latte e formaggi, olivo e olio, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-14.html) |
| Poggio Fecondo | Nocera Inferiore | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-29.html) |
| Fuoco di Nigro Serafina | Oliveto Citra | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-228.html) |
| Il Fontanone | San Cipriano Picentino | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-138.html) |
| La Sfruscià di Tozzi Pasqualina | San Gregorio Magno | `Lácteos y quesos` + `Aceite` + `Carne` | latte e formaggi, olivo e olio, salumi e carni, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-320.html) |
| Cooperativa Nuovo Cilento | San Mauro Cilento | `Lácteos y quesos` + `Aceite` + `Miel` | latte e formaggi, olivo e olio, miele e api, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-105.html) |
| Azienda Agricola Biologica Prisco soc. agr. sas | San Mauro la Bruca | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, miele e api, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-248.html) |
| Il Forno Antico | San Mauro la Bruca | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-137.html) |
| La Rocca degli Ulivi | Sant'Angelo a Fasanella | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-60.html) |
| La Fattoria | Sarno | `Lácteos y quesos` + `Fruta y verdura` | latte e formaggi, ortaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-230.html) |
| Antica Tenuta Chiola di Chiola Delfino Tito | Sicignano degli Alburni | `Lácteos y quesos` + `Aceite` + `Conservas` | latte e formaggi, olivo e olio, conserve e confetture, ortaggi, frutta | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-288.html) |
| Il Falco del Cilento | Torchiara | `Lácteos y quesos` + `Aceite` + `Miel` | latte e formaggi, olivo e olio, miele e api | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-130.html) |
| Il Frescale | Tramonti | `Lácteos y quesos` + `Fruta y verdura` + `Condimentos` | latte e formaggi, ortaggi, frutta, erbe e piante officinali | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-210.html) |
| Green Park | Trentinara | `Lácteos y quesos` | latte e formaggi | [web](http://www.agricoltura.regione.campania.it/fattorie/scheda-142.html) |
