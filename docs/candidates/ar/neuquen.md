...
- CSV destino: `data/csv/ar/patagonia/neuquen.csv`
...
Sin barrer: el chivito criollo del Norte Neuquino, que tiene denominación de origen, y la fruta fina del valle.
