...
- CSV destino: `data/csv/ar/noroeste/la-rioja-argentina.csv`
...
- **Finca Don Felipe Regionales** (Famatina) — «Nogales-nueces seleccionadas / Daniel» y un perfil
  personal de Facebook: sin teléfono, correo ni web con los que formar una fila usable.
