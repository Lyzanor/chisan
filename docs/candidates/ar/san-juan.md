...
- CSV destino: `data/csv/ar/cuyo/san-juan.csv`
...
Sin barrer: la Cámara de Bodegueros de San Juan (aparece como socia del directorio, sin web propia en él), el aceite de oliva y el melón de Media Agua, que tiene indicación geográfica.
