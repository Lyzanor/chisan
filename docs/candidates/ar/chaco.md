...
- CSV destino: `data/csv/ar/nordeste/chaco.csv`
...
- **Productor de harina de algarroba** (Concepción del Bermejo) — la ficha se titula con el
  producto, no con un nombre comercial.
