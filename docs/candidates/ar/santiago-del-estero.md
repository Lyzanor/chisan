# Santiago del Estero — candidatos

- CSV destino: `data/csv/ar/noroeste/santiago-del-estero.csv`
...
- **Productores de harina de algarroba** (Figueroa) — la ficha se titula con el producto, no
