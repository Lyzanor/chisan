# Entre Ríos — candidatos

- CSV destino: `data/csv/ar/pampeana/entre-rios.csv`
...
- **La Porota Espacio Rural para la Agroecología** (La Picada) — solo nombre y Facebook.
- **La Vere Chacra Agroecológica** (Gualeguaychú) — domicilio en Sarandí y Facebook, sin producto
  declarado.
...
- **La Creciente** (Diamante) — solo «espacio agroecológico», sin actividad ni contacto.
