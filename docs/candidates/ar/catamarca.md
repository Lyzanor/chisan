# Catamarca — candidatos

- CSV destino: `data/csv/ar/noroeste/catamarca.csv`
...
- **Finca Buena Vida** (San José) — la ficha solo trae un teléfono, el paraje Famatanca y un
  Facebook; no declara qué produce.
