...
| Hofmann — centro Badalona | Badalona | infraestructura de producción/I+D, no fila nueva: la marca ya está (`pastisseria-hofmann`) | nota candidatos 2026-06-05 (`529e83b`) |
| Parallelo Gelato — Time Out Market | Barcelona | punto de venta, no productor nuevo: ya está (`parallelo-gelato`) | nota candidatos 2026-06-05 (`529e83b`) |
...
**MielHada** (`mielhada`): marca del apicultor (+300
...
- **Terrassa:** Hort del Silenci (hortdelsilenci.com; agricultores y elaboradores eco con almacén en Terrassa; su obrador es la Masia Can Viver de Torrebonica = Agrària Can Viver SL del DAR, fila quimera purgada de Montcada) — no está en el CSV. Su página *On som* (2026-08-19) confirma que la marca es multisede y no cuelga de un solo municipio: cultivo en Torrebonica, Finca Parc Samà (Cambrils) y la Cooperativa d'Artesa de Segre; **elaboración y etiquetado en Celrà (Gironès)**; almacén en Terrassa y Artesa de Segre; domicilio social en Carrer Major 1, Muller, els Plans de Sió (Hort del Silenci SL, CIF B25817164). Antes de abrir fila hay que decidir qué unidad la justifica — Terrassa es almacén, no obrador. La cooperativa d'Artesa de Segre sí está integrada como fila propia de `lleida.csv` por su sección ECO Artesa 2058
