# Viseu — candidatos en espera

Revisión cerrada el 2026-08-10. Casa da Ínsua se reconcilió con su fila de vino
existente y se amplió con sus otras producciones; se añadieron Queijaria de
Germil, Queijaria Flor da Beira y Mickas Craft Beer. Quedan 16 casos en `hold`.

| nombre | concelho | categoría | estado | qué falta |
|---|---|---|---|---|
| Quinta do Cubo | Mangualde | Vino | hold | solo existe material antiguo y no figura en la oferta municipal actual; confirmar actividad |
...
| Pastelaria Nossa Senhora dos Remédios | Lamego | Dulces y repostería | hold | fabricación propia y ubicación de obrador |
| Pastelaria Scala | Lamego | Dulces y repostería | hold | fabricación propia y ubicación de obrador |
| Pastelaria Trás da Sé | Lamego | Dulces y repostería | hold | fabricación propia y ubicación de obrador |
| Pastelaria Dalila | Lamego | Dulces y repostería | hold | fabricación propia y ubicación de obrador |
