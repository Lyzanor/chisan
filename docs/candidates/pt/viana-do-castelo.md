...
- CSV destino: `data/csv/pt/norte/viana-do-castelo.csv`
- Fecha de búsqueda: 2026-08-13 (actualización sectorial de cerveza) y 2026-08-10 (revisión integral).
- Fuentes de descubrimiento: [Cervejeiros de Portugal](https://www.cervejeirosdeportugal.pt), [Racius](https://www.racius.com), [Untappd](https://untappd.com) y bolsas de empleo del sector.
- Alcance y trabajo pendiente: comprobar reapertura de obradores y distinguir instalaciones de producción física propias de colaboraciones nómadas.
