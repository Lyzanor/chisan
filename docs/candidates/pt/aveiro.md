...
- CSV destino: `data/csv/pt/centro/aveiro.csv`
- Fecha de búsqueda: 2026-08-13 (actualización sectorial de cerveza) y 2026-08-10 (revisión de categorías infrarrepresentadas).
- Fuentes de descubrimiento: [Cervejeiros de Portugal](https://www.cervejeirosdeportugal.pt), [Produtos Tradicionais Portugueses (PTPT)](https://www.ptpt.pt/produtores), [ADRIMAG](https://www.adrimag.com.pt), [Racius](https://www.racius.com) y webs oficiales.
- Alcance y trabajo pendiente: verificar obradores propios frente a restauración y confirmar canales de venta directa para nuevas altas.
