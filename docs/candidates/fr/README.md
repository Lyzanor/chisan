...
Corte editorial: 2026-08-09.

- Candidatos iniciales de Agence Bio: **2020**.
- Incorporados con identidad, actividad, commune, ubicación y oferta pública contrastadas: **308**.
- Descartados con exclusión positiva documentada: **32**.
- Retenidos para futuras revisiones por evidencia insuficiente o conflicto pendiente: **1680**.
