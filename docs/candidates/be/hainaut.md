...
Revisión individual del lote Apaq-W de 2026-08-08: 16 candidatos confirmados y publicados (13 verificados y 3 parciales) y 4 retenidos por falta de prueba actual suficiente. No hubo descartes definitivos.

| Candidato retenido | Estado | Motivo y fuente revisada |
|---|---|---|
| Essence Végétale | En espera | La ficha Apaq-W sostiene identidad y dirección, pero no se encontró una presencia primaria ni otra prueba actual de producción. |
