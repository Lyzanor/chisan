...
- CSV: `data/csv/jp/shikoku/kochi.csv` (44 filas tras la revisión integral de 2026-08-11).
...
|---|---|---|---|---|---|
| たけまさ商店 | ⚠ | Pescado | búsqueda dirigida + web propia | https://takemasa-syouten.com/ | ⚠ municipio sin confirmar (Tosashimizu); 宗田節, centenaria; revisado 2026-08-11: retenido (200, falta confirmar actividad o unidad productiva) |
