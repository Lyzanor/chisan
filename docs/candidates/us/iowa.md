...
- CSV destino: `data/csv/us/west-north-central/iowa.csv`
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Iowa identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Iowa con colmenares propios, venta directa y web oficial.
