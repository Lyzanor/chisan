# Candidatos — Louisiana

- CSV destino: `data/csv/us/west-south-central/louisiana.csv`
...
Target: `data/csv/us/west-south-central/louisiana.csv`, categoría `Pescado`.
Búsqueda de barcos camaroneros de bajura, granjas de cangrejo de río (crawfish) en arrozales y extracción tradicional de ostras en Luisiana.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Luisiana con colmenares propios, venta directa y web oficial.
