# Candidatos — New Hampshire

- CSV destino: `data/csv/us/new-england/new-hampshire.csv`
...
Target: `data/csv/us/new-england/new-hampshire.csv`, categoría `Pescado`.
Búsqueda de ostricultores artesanales de Great Bay y Little Bay en New Hampshire.
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de New Hampshire identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de New Hampshire con colmenares propios, venta directa y web oficial.
