# Candidatos — Connecticut

- CSV destino: `data/csv/us/new-england/connecticut.csv`
...
Target: `data/csv/us/new-england/connecticut.csv`, categoría `Pescado`.
Búsqueda de ostricultores históricos y cultivo de bivalvos en Long Island Sound (Connecticut).
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Connecticut identificados con unidad productiva y web oficial.
...
Candidatos de microtostaderos artesanales y tostadores independientes de café de especialidad de Connecticut con tostaduría propia identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Connecticut con colmenares propios, venta directa y web oficial.
