...
- CSV destino: `data/csv/us/new-england/maine.csv`
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Maine identificados con unidad productiva y web oficial.
...
Target: `data/csv/us/new-england/maine.csv`, categoría `Pescado`.
Búsqueda de ostricultores del río Damariscotta y Casco Bay, cultivo de mejillones, flotas langosteras familiares y ahumaderos artesanales en Maine.
...
Candidatos de destilerías artesanales de Maine con elaboración de grano local y destilados costeros.
...
Candidatos de microtostaderos artesanales y tostadores independientes de café de especialidad de Maine con tostaduría propia identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Maine con colmenares propios, venta directa y web oficial.
