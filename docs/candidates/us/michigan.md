...
- CSV destino: `data/csv/us/east-north-central/michigan.csv`
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Míchigan identificados con unidad productiva y web oficial.
...
Target: `data/csv/us/east-north-central/michigan.csv`, categoría `Pescado`.
Búsqueda de pesquerías profesionales tradicionales y ahumaderos de corégono y trucha de los Grandes Lagos en Michigan.
...
Candidatos de microtostaderos artesanales y tostadores independientes de café de especialidad de Michigan con tostaduría propia identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Michigan con colmenares propios, venta directa y web oficial.
