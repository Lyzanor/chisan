# Candidatos — North Carolina

- CSV destino: `data/csv/us/south-atlantic/north-carolina.csv`
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Carolina del Norte identificados con unidad productiva y web oficial.
...
Target: `data/csv/us/south-atlantic/north-carolina.csv`, categoría `Pescado`.
Búsqueda de ostricultores artesanales de Outer Banks / Pamlico Sound y pesquerías comunitarias en Carolina del Norte.
...
Candidatos de microtostaderos artesanales y tostadores independientes de café de especialidad de Carolina del Norte con tostaduría propia identificados con unidad productiva y web oficial.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Carolina del Norte con colmenares propios, venta directa y web oficial.
