...
- CSV destino: `data/csv/us/east-south-central/alabama.csv`
...
Target: `data/csv/us/east-south-central/alabama.csv`, categoría `Pescado`.
Búsqueda de ostricultores de maricultura en suspensión en Portersville Bay y Mobile Bay (Alabama).
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Alabama con colmenares propios, venta directa y web oficial.
