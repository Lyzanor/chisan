...
- CSV destino: `data/csv/us/south-atlantic/delaware.csv`
...
Target: `data/csv/us/south-atlantic/delaware.csv`, categoría `Pescado`.
Búsqueda de ostricultores artesanales de las bahías interiores de Delaware (Inland Bays).
