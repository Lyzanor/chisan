# Candidatos — New Jersey

- CSV destino: `data/csv/us/middle-atlantic/new-jersey.csv`
...
Target: `data/csv/us/middle-atlantic/new-jersey.csv`, categoría `Pescado`.
Búsqueda de ostricultores artesanales de Barnegat Bay y Delaware Bay en New Jersey.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Nueva Jersey con colmenares propios, venta directa y web oficial.
