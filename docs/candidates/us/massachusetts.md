# Candidatos — Massachusetts

- CSV destino: `data/csv/us/new-england/massachusetts.csv`
...
Candidatos de queserías artesanas, obradores de granja y elaboradores tradicionales de Massachusetts identificados con unidad productiva y web oficial.
...
Candidatos de microtostaderos artesanales y tostadores independientes de café de especialidad de Massachusetts con tostaduría propia identificados con unidad productiva y web oficial.
...
Target: `data/csv/us/new-england/massachusetts.csv`, categoría `Pescado`.
Búsqueda de ostricultores históricos en Cape Cod y Duxbury Bay, cooperativas de pesca artesanal de bajura y viveros de marisco en Massachusetts.
...
Candidatos de destilerías artesanales y licores botánicos de Massachusetts con alambiques propios.
...
Candidatos de apicultores locales, granjas apícolas y elaboradores de miel artesana de Massachusetts con colmenares propios, venta directa y web oficial.
