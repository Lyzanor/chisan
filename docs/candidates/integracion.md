...
| 2.5 | Navarra | **2.5a Ribera (11) + 2.5b Tierra Estella/Valdizarbe (9) hechos** = 19 altas (10 verif —8 VO=sí— + 9 parcial; 1 diferida Ontañón→Rioja). Falta: Baja Montaña (6, incl. Aroa/Zurukuain sin centroide). Correcciones pendientes: `mendiko-aibar-oibar`, `bodega-otazu-otazu` | 26 | ~1 (2/3) | en curso |
