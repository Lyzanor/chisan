...
CSV_PATH = 'data/csv/cantabria/cantabria.csv'
OUTPUT_DIR = 'public/productores/cantabria'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Cantabria...")
    ...
    for i, row in enumerate(rows):
        ...
        for score, src, url in scored_candidates:
            ...
            if download_and_process_image(url, output_path):
                row['imagen'] = f"/productores/cantabria/{output_filename}"
                success = True
                updated_count += 1
