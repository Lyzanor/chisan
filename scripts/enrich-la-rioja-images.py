...
CSV_PATH = 'data/csv/la-rioja/la-rioja.csv'
OUTPUT_DIR = 'public/productores/la-rioja'
PUBLIC_PREFIX = '/productores/la-rioja'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in La Rioja...")
