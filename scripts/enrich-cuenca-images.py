...
CSV_PATH = 'data/csv/castilla-la-mancha/cuenca.csv'
OUTPUT_DIR = 'public/productores/cuenca'
PUBLIC_PREFIX = '/productores/cuenca'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Cuenca...")
