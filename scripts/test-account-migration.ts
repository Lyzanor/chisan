  ...
  try {
    ...
    assert.deepEqual(
      ...
      [
        ...
        "selection_shelf_whatsapp_links",
        "selection_shelves",
        "staff_grants",
        "user_presentation",
        "users",
    ...
    assert.deepEqual(internalUserReferences.rows, [
      ...
      { table_name: "producer_media_uploads", column_name: "author_user_id" },
      ...
      { table_name: "producer_suggestions", column_name: "author_user_id" },
      { table_name: "producer_suggestions", column_name: "reviewer_user_id" },
      { table_name: "selection_shelf_whatsapp_links", column_name: "user_id" },
      { table_name: "selection_shelves", column_name: "reviewed_by" },
      { table_name: "selection_shelves", column_name: "user_id" },
