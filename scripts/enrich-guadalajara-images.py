...
CSV_PATH = 'data/csv/castilla-la-mancha/guadalajara.csv'
OUTPUT_DIR = 'public/productores/guadalajara'
PUBLIC_PREFIX = '/productores/guadalajara'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Guadalajara...")
