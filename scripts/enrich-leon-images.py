...
CSV_PATH = 'data/csv/castilla-y-leon/leon.csv'
OUTPUT_DIR = 'public/productores/leon'
PUBLIC_PREFIX = '/productores/leon'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in León...")
