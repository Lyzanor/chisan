...
CSV_PATH = 'data/csv/castilla-y-leon/valladolid.csv'
OUTPUT_DIR = 'public/productores/valladolid'
PUBLIC_PREFIX = '/productores/valladolid'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Valladolid...")
    ...
    for i, row in enumerate(rows):
        ...
        if any(portal in domain for portal in ['facebook.com', 'instagram.com', 'twitter.com', 'x.com', 'youtube.com', 'tiktok.com', 'linktr.ee']):
            continue
