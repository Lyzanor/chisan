...
CSV_PATH = 'data/csv/extremadura/badajoz.csv'
OUTPUT_DIR = 'public/productores/badajoz'
PUBLIC_PREFIX = '/productores/badajoz'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Badajoz...")
