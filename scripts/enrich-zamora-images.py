...
CSV_PATH = 'data/csv/castilla-y-leon/zamora.csv'
OUTPUT_DIR = 'public/productores/zamora'
PUBLIC_PREFIX = '/productores/zamora'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Zamora...")
    ...
    for i, row in enumerate(rows):
        ...
        if any(portal in domain for portal in ['alimentosdezamora.info', 'dotoro.com', 'facebook.com', 'instagram.com', 'gff.co.uk', 'exquisiteza.es', 'quesozamorano.com', 'sayago.com']):
            continue
