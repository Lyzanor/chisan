...
export const CATEGORY_MARKERS = {
  ...
  // Bollería and pastries made by bakeries as standard oven output (`pasteles`,
  // `galletas`, `magdalenas`, `hojaldre`) appear in both `Pan y cereal` and
  // `Dulces y repostería` to avoid flagging traditional bakeries as cross-template defects.
  "Dulces y repostería": ["dulce", "dulces", "dols", "dolcos", "pasteleria", "pastelerias", "pastisseria", "pastisserias", "reposteria", "reposterias", "confiteria", "confiterias", "turron", "turrones", "torro", "torrons", "mazapan", "mazapanes", "polvoron", "polvorones", "mantecado", "mantecados", "alfajor", "alfajores", "churro", "churros", "porras", "pestino", "pestinos", "borrachuelo", "borrachuelos", "gofre", "gofres", "flaon", "flaons", "arnadi", "tarta", "tartas", "pastel", "pasteles", "pastis", "pastissos", "magdalena", "magdalenas", "galleta", "galletas", "hojaldre", "hojaldres", "bolleria", "croissant", "ensaimada"],
  "Pan y cereal": ["pan", "panes", "pa", "panets", "ogi", "hogaza", "hogazas", "panaderia", "panaderias", "tahona", "tahonas", "baguette", "baguettes", "coca", "ensaimada", "bolleria", "croissant", "pastel", "pasteles", "pastis", "pastissos", "galleta", "galletas", "magdalena", "magdalenas", "empanada", "torta", "tortas", "hojaldre", "hojaldres", "rosquilla", "rosquillas", "harina", "harinas", "farina", "farines", "espelta", "molienda", "molino", "molinos", "arroz", "arros", "cereal", "cereales", "trigo", "avena", "centeno"],
