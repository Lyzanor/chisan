...
CSV_PATH = 'data/csv/castilla-y-leon/segovia.csv'
OUTPUT_DIR = 'public/productores/segovia'
PUBLIC_PREFIX = '/productores/segovia'
...
def main():
    ...
    print(f"Processing {len(rows)} producers in Segovia...")
    ...
    for i, row in enumerate(rows):
        ...
        # Skip generic portals / aggregator domains so we don't assign their logos to producers
        if any(portal in domain for portal in [
