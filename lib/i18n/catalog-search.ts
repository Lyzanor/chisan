...
const en = {
  ...
  results: "{count} producers · {scope}", sheetResults: "{count} producers in {scope}", more: "Show more", relevance: "Sorted by relevance",
...
const messages: Partial<Record<Locale, Messages>> = {
  ...
  es: {
    ...
    results: "{count} productores · {scope}", sheetResults: "{count} productores en {scope}", more: "Mostrar más", relevance: "Ordenados por relevancia",
  ...
  ca: {
    ...
    results: "{count} productors · {scope}", sheetResults: "{count} productors a {scope}", more: "Mostra'n més", relevance: "Ordenats per rellevància",
