...
const messages = {
  ...
  locationOnboarding: {
    ...
    manualAreaLabel: "Àrea del catàleg",
    manualAreaPlaceholder: "Selecciona una àrea del catàleg",
    locating: "Cercant la teva àrea…",
    dismissed: "La ubicació és opcional. La pots fer servir quan vulguis.",
    savedTitle: "Continua a l'àrea desada",
    savedDescription: "Has desat {area} com a àrea de Chisan.",
    continueInArea: "Continua a {area}",
    changeArea: "Tria una altra àrea",
    forgetArea: "Oblida l'àrea desada",
    errors: {
