...
const messages = {
  ...
  locationOnboarding: {
    ...
    manualCountryLabel: "രാജ്യം",
    manualCountryPlaceholder: "ഒരു രാജ്യം തിരഞ്ഞെടുക്കുക",
    manualAreaLabel: "കാറ്റലോഗ് പ്രദേശം",
    manualAreaPlaceholder: "ഒരു കാറ്റലോഗ് പ്രദേശം തിരഞ്ഞെടുക്കുക",
    locating: "നിങ്ങളുടെ പ്രദേശം പരിശോധിക്കുന്നു…",
    dismissed: "സ്ഥാനം ഐച്ഛികമാണ്. നിങ്ങൾക്ക് ഇഷ്ടമുള്ളപ്പോൾ ഉപയോഗിക്കാം.",
    savedTitle: "നിങ്ങൾ സംരക്ഷിച്ച പ്രദേശത്ത് തുടരുക",
    savedDescription: "{area} നിങ്ങളുടെ Chisan പ്രദേശമായി നിങ്ങൾ സംരക്ഷിച്ചു.",
    continueInArea: "{area}-ൽ തുടരുക",
    changeArea: "മറ്റൊരു പ്രദേശം തിരഞ്ഞെടുക്കുക",
    forgetArea: "സംരക്ഷിച്ച പ്രദേശം മറക്കുക",
    errors: {
      permissionDenied:
