...
const messages = {
  ...
  siteFooter: {
    ...
    aboutLink: "Chisan എങ്ങനെ പ്രവർത്തിക്കുന്നു",
    catalogLink: "ഉൽപ്പാദകരുടെ കാറ്റലോഗ്",
    contactLink: "ബന്ധപ്പെടുക",
  },
  accountActions: {
  ...
  ownerProducerFieldHelp: {
    ...
    url_tienda: "ഉൽപ്പാദകന്റെ സ്വന്തം ഓൺലൈൻ കടയുടെയോ ഔദ്യോഗിക കൂട്ടായ മാർക്കറ്റ്‌പ്ലേസിലെ അവരുടെ കടയുടെയോ HTTP(S) പ്രവേശന പേജ്; ഇത് വെബ്‌സൈറ്റിൽ നിന്ന് വ്യത്യസ്തമായിരിക്കാം. ഇതിന് സ്ഥിരീകരിച്ച ഓൺലൈൻ വിൽപ്പനയും ഓൺലൈൻ കട, മാർക്കറ്റ്‌പ്ലേസ് അല്ലെങ്കിൽ സബ്സ്ക്രിപ്ഷൻ മാർഗവും ആവശ്യമാണ്.",
    "visitas guiadas":
