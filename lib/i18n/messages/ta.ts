...
const messages = {
  ...
  ownerProducerFieldHelp: {
    ...
    url_tienda: "உற்பத்தியாளரின் சொந்த ஆன்லைன் கடை அல்லது அதிகாரப்பூர்வ கூட்டுச் சந்தைத் தளத்தில் உள்ள அவரது கடையின் HTTP(S) நுழைவுப் பக்கம்; இது இணையதளத்திலிருந்து வேறுபடலாம். இதற்கு உறுதிப்படுத்தப்பட்ட ஆன்லைன் விற்பனையும் ஆன்லைன் கடை, சந்தைத் தளம் அல்லது சந்தா வழியும் தேவை.",
  },
