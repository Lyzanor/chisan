...
const messages = {
  ...
  locationOnboarding: {
    ...
    manualCountryLabel: "நாடு",
    manualCountryPlaceholder: "ஒரு நாட்டைத் தேர்ந்தெடுக்கவும்",
    manualAreaLabel: "பட்டியல் பகுதி",
    manualAreaPlaceholder: "ஒரு பட்டியல் பகுதியைத் தேர்ந்தெடுக்கவும்",
    locating: "உங்கள் பகுதி சரிபார்க்கப்படுகிறது…",
    dismissed:
      "இருப்பிடம் விருப்பத்திற்குரியது. நீங்கள் விரும்பும்போது இதைப் பயன்படுத்தலாம்.",
    savedTitle: "நீங்கள் சேமித்த பகுதியில் தொடர்க",
    savedDescription:
      "{area} என்பதை உங்கள் Chisan பகுதியாகச் சேமித்துள்ளீர்கள்.",
    continueInArea: "{area}-இல் தொடர்க",
    changeArea: "வேறு பகுதியைத் தேர்ந்தெடுக்கவும்",
    forgetArea: "சேமித்த பகுதியை மறக்கவும்",
    errors: {
      permissionDenied:
