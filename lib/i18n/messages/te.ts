...
const messages = {
  ...
  locationOnboarding: {
    ...
    manualCountryLabel: "దేశం",
    manualCountryPlaceholder: "ఒక దేశాన్ని ఎంచుకోండి",
    manualAreaLabel: "కేటలాగ్ ప్రాంతం",
    manualAreaPlaceholder: "ఒక కేటలాగ్ ప్రాంతాన్ని ఎంచుకోండి",
    locating: "మీ ప్రాంతాన్ని తనిఖీ చేస్తోంది…",
    dismissed: "స్థానం ఐచ్ఛికం. మీకు నచ్చినప్పుడు ఉపయోగించవచ్చు.",
    savedTitle: "మీరు భద్రపరచిన ప్రాంతంలో కొనసాగండి",
    savedDescription: "మీరు {area}ను మీ Chisan ప్రాంతంగా భద్రపరిచారు.",
    continueInArea: "{area}లో కొనసాగండి",
    changeArea: "వేరే ప్రాంతాన్ని ఎంచుకోండి",
    forgetArea: "భద్రపరచిన ప్రాంతాన్ని మర్చిపోండి",
    errors: {
      permissionDenied:
