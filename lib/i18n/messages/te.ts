...
const messages = {
  ...
  ownerProducerFieldHelp: {
    ...
    url_tienda: "ఉత్పత్తిదారు సొంత ఆన్‌లైన్ దుకాణం లేదా అధికారిక సామూహిక మార్కెట్‌ప్లేస్‌లోని వారి దుకాణం యొక్క HTTP(S) ప్రవేశ పేజీ; ఇది వెబ్‌సైట్‌కు భిన్నంగా ఉండవచ్చు. దీనికి నిర్ధారించిన ఆన్‌లైన్ అమ్మకాలు మరియు ఆన్‌లైన్ దుకాణం, మార్కెట్‌ప్లేస్ లేదా చందా మార్గం అవసరం.",
  },
