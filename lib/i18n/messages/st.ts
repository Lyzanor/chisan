...
const messages = {
  ...
  locationOnboarding: {
    ...
    manualCountryLabel: "Naha",
    manualCountryPlaceholder: "Khetha naha",
    manualAreaLabel: "Sebaka sa lenane",
    manualAreaPlaceholder: "Khetha sebaka sa lenane",
    locating: "E hlahloba sebaka sa hau…",
    dismissed: "Sebaka ke boikhethelo. U ka se sebelisa neng kapa neng.",
    savedTitle: "Tsoela pele sebakeng sa hau se bolokiloeng",
    savedDescription: "U bolokile {area} e le sebaka sa hau sa Chisan.",
    continueInArea: "Tsoela pele ho {area}",
    changeArea: "Khetha sebaka se seng",
    forgetArea: "Lebala sebaka se bolokiloeng",
    errors: {
