...
const ENGLISH_MESSAGES = {
  ...
  whatsappAction: "Write via WhatsApp",
};
...
const MESSAGES: Partial<Record<Locale, ProducerContactMessages>> = {
  ...
  ca: {
    ...
    whatsappAction: "Escriure per WhatsApp",
  },
  de: {
  ...
  fr: {
    ...
    whatsappAction: "Écrire via WhatsApp",
  },
  it: {
  ...
  ja: {
    ...
    whatsappAction: "WhatsAppでメッセージを送る",
  },
  nl: {
    ...
    whatsappAction: "Schrijven via WhatsApp",
  },
  pt: {
    ...
    whatsappAction: "Escrever por WhatsApp",
  },
};
