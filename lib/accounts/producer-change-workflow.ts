...
export const PRODUCER_CHANGE_STATUS_DEFINITIONS = {
  ...
  approved: {
    ...
    shortLabel: "Ready to publish",
    phase: "csv_ready",
    tone: "positive",
    description: "Editorial review is complete. The approved profile and products are waiting for publication.",
    nextAction: "Materialize the approved patch in a local Git worktree.",
    requiresOperatorAction: true,
  },
  applying: {
    label: "Profile prepared; commit pending",
    shortLabel: "Preparing publication",
    phase: "csv_in_progress",
    tone: "active",
    description: "The publication workflow started and still needs a validated commit and finalization.",
    nextAction: "Review and commit the profile and product changes together, then finalize with the commit SHA.",
    requiresOperatorAction: true,
  },
  applied: {
    ...
    phase: "canonical",
    tone: "positive",
    description: "The request is bound to a Git commit containing the approved profile state.",
  ...
  failed: {
    ...
    phase: "attention",
    tone: "danger",
    description: "The publication workflow stopped before a canonical commit was recorded.",
...
export const PRODUCER_CHANGE_VIEWS = {
  ...
  csv: { label: "Publication", statuses: ["approved", "applying"] },
