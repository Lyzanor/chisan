...
export function ProducerFollowToggle({ country, producerId, name, returnTo, locale = "es", compact = false }: {
  country: string; producerId: number; name: string; returnTo: string; locale?: Locale; compact?: boolean;
}) {
  ...
  return <span className={`producer-follow-control${compact ? " producer-follow-control--compact" : ""}`}>
